...
Score::Score(float x, float y) {
    ...
    this->digit[1] = create3DObject(GL_LINES, 2, a, {255,255,255}, GL_FILL);
    this->digit[2] = create3DObject(GL_LINES, 2, b, {255,255,255}, GL_FILL);
    this->digit[3] = create3DObject(GL_LINES, 2, c, {255,255,255}, GL_FILL);
    this->digit[4] = create3DObject(GL_LINES, 2, d, {255,255,255}, GL_FILL);
    this->digit[5] = create3DObject(GL_LINES, 2, e, {255,255,255}, GL_FILL);
    this->digit[6] = create3DObject(GL_LINES, 2, f, {255,255,255}, GL_FILL);
    this->digit[7] = create3DObject(GL_LINES, 2, g, {255,255,255}, GL_FILL);
